...
class Lcd:
    def __init__(self, addr_default=0x27, bus=BUS_NUMBER):
        #TODO my sugestion fix to multiple bus(another gpio pins as sda and scl) and addr
        self.lcd = I2CDevice(addr_default, addr_default, bus)
        self.lcd_write(0x03)
        self.lcd_write(0x03)
        self.lcd_write(0x03)
        self.lcd_write(0x02)
